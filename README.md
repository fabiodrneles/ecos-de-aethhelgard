...
O jogador desenha formas geométricas na tela (Círculo, Triângulo, Linhas, Quadrado, Retângulo) e recebe feedback por áudio (TTS) e vibração (haptics). Nenhuma informação depende da tela — tudo é comunicado por som e toque.
...
- **Ao levantar o dedo,** o motor analisa o traço e três coisas acontecem simultaneamente:
  ...
  2. Uma **voz sintetizada** em português fala o resultado: *"Identificado: Círculo"*, *"Identificado: Triângulo"*, ou *"Gesto não reconhecido"*.
...
As 6 formas que o motor reconhece atualmente são: **Círculo**, **Triângulo**, **Linha Horizontal**, **Linha Vertical**, **Quadrado** e **Retângulo**. São as mesmas formas definidas no design do jogo completo (`PLANEJAMENTO.md`), onde cada uma terá um significado narrativo (ativar mecanismos, ecolocalizar, abrir passagens, etc.).
...
| Triângulo | 3 linhas conectadas formando um triângulo, fechar a forma | "Identificado: Triângulo" |
